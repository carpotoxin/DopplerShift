/obj/item/skillchip/job/command_bodyguard
	...
	skill_description = "A long-thought method of fighting, designed to protect others and subdue enemies, at the cost of parting ways with the brutish guns and lasers"
